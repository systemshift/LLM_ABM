...
def predator_prey(model, params):
    ...
    Args:
        ...
        params: Rule parameters
            ...
            - success_rate: Probability of successful predation (default: 0.5)
            - energy_gain: Energy gained by predator (default: 10, not full prey energy)
    ...
    success_rate = params.get("success_rate", 0.5)  # Reduced from 0.8
    ...
    for predator in predators:
        ...
        if prey_at_position:
            ...
            if random.random() < success_rate:
                # Successful predation - fixed energy gain (not full prey energy)
...
def grazing(model, params):
    """
    Herbivores gain energy from grazing (eating grass/plants)

    Args:
        model: Model dictionary
        params: Rule parameters
            - species: Agent type that grazes (e.g., "rabbit")
    ...
    energy_gain = params.get("energy_gain", 2)
